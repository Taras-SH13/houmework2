...
public class ServiceImpl implements Service {
    ...
    private EntityInMemDaoImpl entityInMemDao; // поле для доступа к базе данных

    public EntityInMemDaoImpl getEntityInMemDao() {
        return entityInMemDao;
    }

    public ServiceImpl(EntityInMemDaoImpl entityInMemDao) { // конструктор для создания базы данных
